...
fun FontSelectionScreen(
    ...
    val selectedFontState = rememberPreference(
        SelectedFontKey,
    ...
    val customFontPathState = rememberPreference(
        CustomFontPathKey,
        defaultValue = ""
    )
    ...
    Column(
        Modifier
            .windowInsetsPadding(LocalPlayerAwareWindowInsets.current.only(androidx.compose.foundation.layout.WindowInsetsSides.Horizontal))
            .fillMaxSize()
        ...
        Spacer(Modifier.windowInsetsPadding(LocalPlayerAwareWindowInsets.current.only(androidx.compose.foundation.layout.WindowInsetsSides.Bottom)))
        }
    }
